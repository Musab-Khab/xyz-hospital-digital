...
const canned = [
  { q: ["appointment", "book"], a: "You can book an appointment from the 'Book appointment' button in the header, or visit /appointment." },
  { q: ["emergency", "ambulance"], a: "For emergencies call 1122 (Pakistan) or our 24/7 line 042-111-PAK-HOS." },
  { q: ["lab", "test", "laboratory"], a: "Visit our Laboratory page to view tests & home sample collection — /laboratory." },
  { q: ["doctor", "find"], a: "Browse 320+ specialists in the Doctors page. Filter by department." },
  { q: ["timing", "hours", "open"], a: "OPD: 8AM–10PM daily. Emergency & ICU: 24/7." },
  { q: ["address", "location"], a: "Pakistan Hospital, Jail Road, Lahore, Punjab — visible on the Contact page." },
];
...
export function Chatbot() {
  ...
  const [msgs, setMsgs] = useState<Msg[]>([
    { role: "bot", text: "Assalam-o-Alaikum! I'm the Pakistan Hospital assistant. How can I help you today?" },
  ]);
