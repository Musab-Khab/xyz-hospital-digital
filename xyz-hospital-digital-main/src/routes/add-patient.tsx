...
export const Route = createFileRoute("/add-patient")({
  head: () => ({
    meta: [{ title: "Add Patient — Pakistan Hospital" }, { name: "robots", content: "noindex" }],
  }),
...
function AddPatientPage() {
  ...
  return (
    <PortalLayout
      ...
      role="Admin"
      user={{ name: "Reception Desk", initials: "RD", sub: "Front Office" }}
      nav={nav}
    >
            ...
            <form onSubmit={submit} className="mt-5 grid gap-3">
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Chief complaint / referral notes"
                />
              </div>
        ...
        <Card className="border-border lg:col-span-2">
          <CardContent className="p-0">
            <div className="flex items-center justify-between p-5">
              <h2 className="font-display text-lg font-semibold">Recently registered</h2>
              <Badge variant="secondary">{list.length} patients</Badge>
            </div>
            <Table>
              <TableHeader>
                <TableRow>
