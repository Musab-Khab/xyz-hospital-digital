...
import { LayoutDashboard, Users, FileText, Pill, CalendarRange, Save, Search } from "lucide-react";
...
export const Route = createFileRoute("/doctor")({
  head: () => ({
    meta: [{ title: "Doctor Portal — Pakistan Hospital" }, { name: "robots", content: "noindex" }],
  }),
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow>
                        ...
                        <TableHead>Active condition</TableHead>
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div>
                    <h2 className="font-display text-lg font-semibold">
                      Consultation note — Michael Johnson
                    </h2>
                    <p className="text-sm text-muted-foreground">
                      58 y/o male · MRN 00112340 · Follow-up: hypertension
                    </p>
                  </div>
                  <Button onClick={() => toast.success("Note saved to chart")} className="gap-1.5">
            ...
            <Card className="border-border">
              <CardContent className="p-6">
                ...
                <div className="mt-6 flex justify-end gap-2">
                  ...
                  <Button onClick={() => toast.success("Prescription sent to pharmacy")}>
                    Send to pharmacy
                  </Button>
                </div>
              </CardContent>
