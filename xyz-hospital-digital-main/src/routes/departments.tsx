  ...
  head: () => ({
    meta: [
      { title: "Departments — Pakistan Hospital" },
      {
        name: "description",
        content:
          "Explore 28 specialties at Pakistan Hospital, from cardiology and oncology to pediatrics and emergency medicine.",
      },
    ],
  }),
      ...
      <section className="border-b border-border bg-secondary/40">
        <div className="mx-auto max-w-7xl px-6 py-14 md:py-20">
          ...
          <h1 className="mt-4 font-display text-4xl font-bold tracking-tight md:text-5xl">
            Departments at Pakistan Hospital
          </h1>
          <p className="mt-4 max-w-2xl text-muted-foreground md:text-lg">
            Multidisciplinary teams collaborating across 28 specialties to deliver coordinated care
            under one roof.
          </p>
        </div>
      </section>
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-5 flex flex-wrap gap-2">
                      <Button asChild size="sm">
                        <Link to="/appointment">Book in {d.name}</Link>
                      </Button>
                      <Button asChild size="sm" variant="outline" className="gap-1.5">
                        <Link to="/doctors">
                          See doctors <ArrowRight className="h-3.5 w-3.5" />
                        </Link>
                      </Button>
                    </div>
                  </div>
