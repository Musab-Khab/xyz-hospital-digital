      ...
      <div className="mx-auto max-w-7xl px-6 py-14 grid gap-10 md:grid-cols-2 lg:grid-cols-5">
        <div className="lg:col-span-2">
          ...
          <p className="mt-4 max-w-sm text-sm text-muted-foreground">
            A multi-specialty quaternary care hospital delivering compassionate, evidence-based
            medicine across Pakistan since 1984.
          </p>
          <ul className="mt-5 space-y-2 text-sm text-muted-foreground">
            <li className="flex items-start gap-2">
              <MapPin className="mt-0.5 h-4 w-4 text-primary shrink-0" />
              <span>Jail Road, Gulberg-III, Lahore, Punjab, Pakistan</span>
            </li>
            <li className="flex items-center gap-2">
              <Phone className="h-4 w-4 text-primary shrink-0" />
              <span>+92 42 111-PAK-HOS</span>
            </li>
            <li className="flex items-center gap-2">
              <Mail className="h-4 w-4 text-primary shrink-0" />
              <span>care@pakistanhospital.pk</span>
            </li>
          </ul>
        </div>
        <FooterCol
      ...
      <div className="border-t border-border">
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-3 px-6 py-5 md:flex-row md:items-center">
          <p className="text-xs text-muted-foreground">
            © 2026 Pakistan Hospital. All rights reserved. PMDC · ISO 9001 accredited.
          </p>
          <p className="inline-flex items-center gap-1.5 text-xs font-medium text-foreground/80">
            <Code2 className="h-3.5 w-3.5 text-primary" /> Developed by{" "}
            <span className="font-semibold text-primary">Muhammad Musab</span>
          </p>
